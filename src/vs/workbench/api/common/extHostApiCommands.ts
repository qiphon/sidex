...
const newCommands: ApiCommand[] = [
	...
	new ApiCommand(
		...
		new ApiCommandResult<languages.DocumentHighlight[], types.DocumentHighlight[] | undefined>(
	...
	new ApiCommand(
		...
		new ApiCommandResult<languages.DocumentSymbol[], vscode.SymbolInformation[] | undefined>(
	...
	new ApiCommand(
		...
		new ApiCommandResult<languages.TextEdit[], types.TextEdit[] | undefined>(
	...
	new ApiCommand(
		...
		>('A promise that resolves to an array of Location or LocationLink instances.', mapLocationOrLocationLink)
	),
	new ApiCommand(
	...
	new ApiCommand(
		...
		[ApiCommandArgument.Uri, ApiCommandArgument.Position],
		new ApiCommandResult<languages.Location[], types.Location[] | undefined>(
	...
	new ApiCommand(
		...
		new ApiCommandResult<search.IWorkspaceSymbol[], types.SymbolInformation[]>(
	...
	new ApiCommand(
		...
		[ApiCommandArgument.Uri, ApiCommandArgument.Position],
		new ApiCommandResult<ICallHierarchyItemDto[], types.CallHierarchyItem[]>(
	...
	new ApiCommand(
		...
		new ApiCommandResult<IIncomingCallDto[], types.CallHierarchyIncomingCall[]>(
	...
	new ApiCommand(
		...
		[ApiCommandArgument.CallHierarchyItem],
		new ApiCommandResult<IOutgoingCallDto[], types.CallHierarchyOutgoingCall[]>(
	...
	new ApiCommand(
		...
		[ApiCommandArgument.Uri, ApiCommandArgument.Position],
		new ApiCommandResult<languages.RenameLocation, { range: types.Range; placeholder: string } | undefined>(
	...
	new ApiCommand(
		...
		new ApiCommandResult<IWorkspaceEditDto & { rejectReason?: string }, types.WorkspaceEdit | undefined>(
	...
	new ApiCommand(
		...
		[ApiCommandArgument.Uri],
		new ApiCommandResult<languages.SemanticTokensLegend, types.SemanticTokensLegend | undefined>(
	...
	new ApiCommand(
		...
		new ApiCommandResult<languages.SignatureHelp, vscode.SignatureHelp | undefined>(
	...
	new ApiCommand(
		...
		new ApiCommandResult<languages.CodeLens[], vscode.CodeLens[] | undefined>(
	...
	new ApiCommand(
		...
		new ApiCommandResult<CustomCodeAction[], (vscode.CodeAction | vscode.Command | undefined)[] | undefined>(
	...
	new ApiCommand(
		...
		new ApiCommandResult<languages.IColorPresentation[], types.ColorPresentation[]>(
			...
			tryMapWith(item => {
				return {
					...
					filenamePattern: item.filenamePattern.map(pattern =>
						typeConverters.NotebookExclusiveDocumentPattern.to(pattern)
					)
				};
			})
		)
	...
	new ApiCommand(
		...
		[
			ApiCommandArgument.Uri,
			ApiCommandArgument.Range,
			new ApiCommandArgument<types.InlineValueContext, IInlineValueContextDto>(
				'context',
	...
	new ApiCommand(
		...
		[ApiCommandArgument.Uri, ApiCommandArgument.Position],
		new ApiCommandResult<ITypeHierarchyItemDto[], types.TypeHierarchyItem[]>(
