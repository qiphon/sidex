...
import { IIgnoredExtensionsManagementService, IUserDataAutoSyncService, IUserDataSyncEnablementService, SyncResource } from '../../../../platform/userDataSync/common/nullUserDataSync.js';
