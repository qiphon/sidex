	...
	class ToggleCommandCenter extends ToggleTitleBarConfigAction {
		constructor() {
			super(
				...
				localize('toggle.commandCenterDescription', 'Toggle visibility of the Command Center in title bar'),
				1,
...
registerAction2(
	class ToggleNavigationControl extends ToggleTitleBarConfigAction {
		constructor() {
			super(
				'workbench.navigationControl.enabled',
				localize('toggle.navigation', 'Navigation Controls'),
				localize('toggle.navigationDescription', 'Toggle visibility of the Navigation Controls in title bar'),
				2,
				ContextKeyExpr.and(
					IsCompactTitleBarContext.toNegated(),
					ContextKeyExpr.has(`config.${LayoutSettings.COMMAND_CENTER}`)
				)
			);
		}
	}
	...
	class ToggleLayoutControl extends ToggleTitleBarConfigAction {
		constructor() {
			super(
				...
				localize('toggle.layoutDescription', 'Toggle visibility of the Layout Controls in title bar'),
				4
			);
		}
	}
...
registerAction2(
	class ToggleNotificationsButton extends ToggleTitleBarConfigAction {
		constructor() {
			super(
				NotificationsSettings.NOTIFICATIONS_BUTTON,
				localize('toggle.notifications', 'Notifications'),
				localize('toggle.notificationsDescription', 'Toggle visibility of the Notifications button in title bar'),
				5,
...
class ToggleCustomTitleBar extends Action2 {
	...
	run(accessor: ServicesAccessor, ..._args: unknown[]): void {
		...
		const titleBarVisibility = configService.getValue<CustomTitleBarVisibility>(
