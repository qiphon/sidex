...
export namespace CoreNavigationCommands {
	...
	export const MoveTo: CoreEditorCommand<MoveCommandOptions> = registerEditorCommand(
	...
	export const MoveToSelect: CoreEditorCommand<MoveCommandOptions> = registerEditorCommand(
		new BaseMoveToCommand({
			id: '_moveToSelect',
	...
	export const ColumnSelect: CoreEditorCommand<ColumnSelectCommandOptions> = registerEditorCommand(
	...
	export const CursorColumnSelectLeft: CoreEditorCommand<BaseCommandOptions> = registerEditorCommand(
	...
	export const CursorColumnSelectRight: CoreEditorCommand<BaseCommandOptions> = registerEditorCommand(
		new (class extends ColumnSelectCommand {
			constructor() {
				super({
	...
	export const CursorColumnSelectUp: CoreEditorCommand<BaseCommandOptions> = registerEditorCommand(
	...
	export const CursorColumnSelectPageUp: CoreEditorCommand<BaseCommandOptions> = registerEditorCommand(
		new ColumnSelectUpCommand({
			isPaged: true,
	...
	export const CursorColumnSelectDown: CoreEditorCommand<BaseCommandOptions> = registerEditorCommand(
	...
	export const CursorColumnSelectPageDown: CoreEditorCommand<BaseCommandOptions> = registerEditorCommand(
		new ColumnSelectDownCommand({
			isPaged: true,
	...
	export const CursorLeft: CoreEditorCommand<CursorMoveCommandOptions> = registerEditorCommand(
	...
	export const CursorLeftSelect: CoreEditorCommand<CursorMoveCommandOptions> = registerEditorCommand(
		new CursorMoveBasedCommand({
			args: {
				direction: CursorMove_.Direction.Left,
				unit: CursorMove_.Unit.None,
	...
	export const CursorRight: CoreEditorCommand<CursorMoveCommandOptions> = registerEditorCommand(
		new CursorMoveBasedCommand({
			args: {
	...
	export const CursorRightSelect: CoreEditorCommand<CursorMoveCommandOptions> = registerEditorCommand(
		new CursorMoveBasedCommand({
			args: {
				direction: CursorMove_.Direction.Right,
				unit: CursorMove_.Unit.None,
	...
	export const CursorUp: CoreEditorCommand<CursorMoveCommandOptions> = registerEditorCommand(
		new CursorMoveBasedCommand({
			args: {
	...
	export const CursorUpSelect: CoreEditorCommand<CursorMoveCommandOptions> = registerEditorCommand(
		new CursorMoveBasedCommand({
			args: {
				direction: CursorMove_.Direction.Up,
				unit: CursorMove_.Unit.WrappedLine,
	...
	export const CursorPageUp: CoreEditorCommand<CursorMoveCommandOptions> = registerEditorCommand(
		new CursorMoveBasedCommand({
			args: {
				direction: CursorMove_.Direction.Up,
				unit: CursorMove_.Unit.WrappedLine,
	...
	export const CursorPageUpSelect: CoreEditorCommand<CursorMoveCommandOptions> = registerEditorCommand(
		new CursorMoveBasedCommand({
			args: {
				direction: CursorMove_.Direction.Up,
				unit: CursorMove_.Unit.WrappedLine,
	...
	export const CursorDown: CoreEditorCommand<CursorMoveCommandOptions> = registerEditorCommand(
		new CursorMoveBasedCommand({
			args: {
	...
	export const CursorDownSelect: CoreEditorCommand<CursorMoveCommandOptions> = registerEditorCommand(
		new CursorMoveBasedCommand({
			args: {
				direction: CursorMove_.Direction.Down,
				unit: CursorMove_.Unit.WrappedLine,
	...
	export const CursorPageDown: CoreEditorCommand<CursorMoveCommandOptions> = registerEditorCommand(
		new CursorMoveBasedCommand({
			args: {
				direction: CursorMove_.Direction.Down,
				unit: CursorMove_.Unit.WrappedLine,
	...
	export const CursorPageDownSelect: CoreEditorCommand<CursorMoveCommandOptions> = registerEditorCommand(
		new CursorMoveBasedCommand({
			args: {
				direction: CursorMove_.Direction.Down,
				unit: CursorMove_.Unit.WrappedLine,
	...
	export const CreateCursor: CoreEditorCommand<CreateCursorCommandOptions> = registerEditorCommand(
	...
	export const LastCursorMoveToSelect: CoreEditorCommand<MoveCommandOptions> = registerEditorCommand(
	...
	export const CursorHome: CoreEditorCommand<BaseCommandOptions> = registerEditorCommand(
		new HomeCommand({
			inSelectionMode: false,
			id: 'cursorHome',
			precondition: undefined,
	...
	export const CursorHomeSelect: CoreEditorCommand<BaseCommandOptions> = registerEditorCommand(
		new HomeCommand({
			inSelectionMode: true,
			id: 'cursorHomeSelect',
			precondition: undefined,
	...
	export const CursorLineStart: CoreEditorCommand<BaseCommandOptions> = registerEditorCommand(
	...
	export const CursorLineStartSelect: CoreEditorCommand<BaseCommandOptions> = registerEditorCommand(
		new LineStartCommand({
			inSelectionMode: true,
	...
	export const CursorEnd: CoreEditorCommand<EndCommandOptions> = registerEditorCommand(
		new EndCommand({
			inSelectionMode: false,
			id: 'cursorEnd',
			precondition: undefined,
	...
	export const CursorEndSelect: CoreEditorCommand<EndCommandOptions> = registerEditorCommand(
		new EndCommand({
			inSelectionMode: true,
			id: 'cursorEndSelect',
			precondition: undefined,
	...
	export const CursorLineEnd: CoreEditorCommand<BaseCommandOptions> = registerEditorCommand(
		new LineEndCommand({
			inSelectionMode: false,
			id: 'cursorLineEnd',
			precondition: undefined,
	...
	export const CursorLineEndSelect: CoreEditorCommand<BaseCommandOptions> = registerEditorCommand(
		new LineEndCommand({
			inSelectionMode: true,
	...
	export const CursorTop: CoreEditorCommand<BaseCommandOptions> = registerEditorCommand(
		new TopCommand({
			inSelectionMode: false,
			id: 'cursorTop',
			precondition: undefined,
	...
	export const CursorTopSelect: CoreEditorCommand<BaseCommandOptions> = registerEditorCommand(
		new TopCommand({
			inSelectionMode: true,
			id: 'cursorTopSelect',
			precondition: undefined,
	...
	export const CursorBottom: CoreEditorCommand<BaseCommandOptions> = registerEditorCommand(
		new BottomCommand({
			inSelectionMode: false,
			id: 'cursorBottom',
			precondition: undefined,
	...
	export const CursorBottomSelect: CoreEditorCommand<BaseCommandOptions> = registerEditorCommand(
		new BottomCommand({
			inSelectionMode: true,
	...
	export const ScrollLineUp: CoreEditorCommand<BaseCommandOptions> = registerEditorCommand(
	...
	export const ScrollPageUp: CoreEditorCommand<BaseCommandOptions> = registerEditorCommand(
		new (class extends CoreEditorCommand<BaseCommandOptions> {
			constructor() {
				super({
					id: 'scrollPageUp',
	...
	export const ScrollEditorTop: CoreEditorCommand<BaseCommandOptions> = registerEditorCommand(
		new (class extends CoreEditorCommand<BaseCommandOptions> {
			constructor() {
				super({
					id: 'scrollEditorTop',
	...
	export const ScrollLineDown: CoreEditorCommand<BaseCommandOptions> = registerEditorCommand(
		new (class extends CoreEditorCommand<BaseCommandOptions> {
			constructor() {
				super({
					id: 'scrollLineDown',
	...
	export const ScrollPageDown: CoreEditorCommand<BaseCommandOptions> = registerEditorCommand(
		new (class extends CoreEditorCommand<BaseCommandOptions> {
			constructor() {
				super({
					id: 'scrollPageDown',
	...
	export const ScrollEditorBottom: CoreEditorCommand<BaseCommandOptions> = registerEditorCommand(
		new (class extends CoreEditorCommand<BaseCommandOptions> {
			constructor() {
				super({
	...
	export const ScrollLeft: CoreEditorCommand<BaseCommandOptions> = registerEditorCommand(
		new (class extends CoreEditorCommand<BaseCommandOptions> {
			constructor() {
				super({
					id: 'scrollLeft',
	...
	export const ScrollRight: CoreEditorCommand<BaseCommandOptions> = registerEditorCommand(
		new (class extends CoreEditorCommand<BaseCommandOptions> {
			constructor() {
				super({
					id: 'scrollRight',
	...
	export const WordSelect: CoreEditorCommand<MoveCommandOptions> = registerEditorCommand(
		new WordCommand({
			inSelectionMode: false,
			id: '_wordSelect',
			precondition: undefined
	...
	export const WordSelectDrag: CoreEditorCommand<MoveCommandOptions> = registerEditorCommand(
		new WordCommand({
			inSelectionMode: true,
			id: '_wordSelectDrag',
			precondition: undefined
	...
	export const LastCursorWordSelect: CoreEditorCommand<MoveCommandOptions> = registerEditorCommand(
		new (class extends CoreEditorCommand<MoveCommandOptions> {
			constructor() {
				super({
	...
	export const LineSelect: CoreEditorCommand<MoveCommandOptions> = registerEditorCommand(
		new LineCommand({
			inSelectionMode: false,
			id: '_lineSelect',
			precondition: undefined
	...
	export const LineSelectDrag: CoreEditorCommand<MoveCommandOptions> = registerEditorCommand(
		new LineCommand({
			inSelectionMode: true,
			id: '_lineSelectDrag',
			precondition: undefined
	...
	export const LastCursorLineSelect: CoreEditorCommand<MoveCommandOptions> = registerEditorCommand(
	...
	export const LastCursorLineSelectDrag: CoreEditorCommand<MoveCommandOptions> = registerEditorCommand(
		new LastCursorLineCommand({
			inSelectionMode: true,
	...
	export const CancelSelection: CoreEditorCommand<BaseCommandOptions> = registerEditorCommand(
		new (class extends CoreEditorCommand<BaseCommandOptions> {
			constructor() {
				super({
					id: 'cancelSelection',
	...
	export const RemoveSecondaryCursors: CoreEditorCommand<BaseCommandOptions> = registerEditorCommand(
		new (class extends CoreEditorCommand<BaseCommandOptions> {
			constructor() {
				super({
	...
	export const RevealLine: CoreEditorCommand<RevealLineCommandOptions> = registerEditorCommand(
	...
	export const SetSelection: CoreEditorCommand<SetSelectionCommandOptions> = registerEditorCommand(
			...
			constructor() {
				super({
					...
					kbOpts: {
						...
						mac: {
							primary: KeyCode.Delete,
							secondary: [KeyMod.WinCtrl | KeyCode.KeyD, KeyMod.WinCtrl | KeyCode.Delete]
						}
					}
				});
			}
