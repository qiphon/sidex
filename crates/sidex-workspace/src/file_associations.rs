...
fn builtin_associations() -> Vec<LanguageAssociation> {
    vec![
        ...
        lang("typescript", &[".ts", ".mts", ".cts"], &[], &[], "text/typescript"),
        lang("typescriptreact", &[".tsx"], &[], &[], "text/tsx"),
        lang("javascript", &[".js", ".mjs", ".cjs"], &[], &["^#!.*\\bnode\\b"], "text/javascript"),
        lang("javascriptreact", &[".jsx"], &[], &[], "text/jsx"),
        lang("python", &[".py", ".pyw", ".pyi"], &[], &["^#!.*\\bpython[23]?\\b"], "text/x-python"),
        lang("go", &[".go"], &[], &[], "text/x-go"),
        lang("java", &[".java"], &[], &[], "text/x-java"),
        lang("c", &[".c"], &[], &[], "text/x-c"),
        lang("cpp", &[".cpp", ".cc", ".cxx", ".c++"], &[], &[], "text/x-c++"),
        lang("cheader", &[".h", ".hh", ".hpp", ".hxx"], &[], &[], "text/x-c-header"),
        lang("csharp", &[".cs", ".csx"], &[], &[], "text/x-csharp"),
        lang("ruby", &[".rb", ".gemspec"], &["Gemfile", "Rakefile"], &["^#!.*\\bruby\\b"], "text/x-ruby"),
        ...
        lang("json", &[".json", ".jsonl"], &[".babelrc", ".eslintrc", "tsconfig.json"], &[], "application/json"),
        lang("jsonc", &[".jsonc"], &["settings.json", "launch.json", "tasks.json"], &[], "application/json"),
        lang("yaml", &[".yaml", ".yml"], &[], &[], "text/x-yaml"),
        lang("toml", &[".toml"], &["Cargo.toml", "pyproject.toml"], &[], "text/x-toml"),
        lang("markdown", &[".md", ".markdown", ".mdx"], &[], &[], "text/markdown"),
        lang("xml", &[".xml", ".xsd", ".xsl", ".svg"], &[], &["^<\\?xml"], "text/xml"),
        lang("sql", &[".sql"], &[], &[], "text/x-sql"),
        lang("shellscript", &[".sh", ".bash", ".zsh"], &[".bashrc", ".zshrc", ".profile", ".bash_profile"], &["^#!.*\\b(bash|sh|zsh)\\b"], "text/x-shellscript"),
        lang("powershell", &[".ps1", ".psm1", ".psd1"], &[], &[], "text/x-powershell"),
        lang("bat", &[".bat", ".cmd"], &[], &[], "text/x-bat"),
        lang("dockerfile", &[".dockerfile"], &["Dockerfile", "Containerfile"], &[], "text/x-dockerfile"),
        lang("gitignore", &[".gitignore"], &[".gitignore"], &[], "text/plain"),
        lang("gitattributes", &[".gitattributes"], &[".gitattributes"], &[], "text/plain"),
        ...
        lang("clojure", &[".clj", ".cljs", ".cljc", ".edn"], &[], &[], "text/x-clojure"),
        lang("fsharp", &[".fs", ".fsi", ".fsx"], &[], &[], "text/x-fsharp"),
        lang("perl", &[".pl", ".pm"], &[], &["^#!.*\\bperl\\b"], "text/x-perl"),
        lang("makefile", &[], &["Makefile", "makefile", "GNUmakefile"], &[], "text/x-makefile"),
        lang("cmake", &[".cmake"], &["CMakeLists.txt"], &[], "text/x-cmake"),
        ...
        lang("handlebars", &[".hbs", ".handlebars"], &[], &[], "text/x-handlebars"),
        lang("ini", &[".ini", ".cfg", ".conf"], &[], &[], "text/x-ini"),
        lang("env", &[".env"], &[".env", ".env.local", ".env.development", ".env.production"], &[], "text/plain"),
        lang("terraform", &[".tf", ".tfvars"], &[], &[], "text/x-terraform"),
        lang("zig", &[".zig"], &[], &[], "text/x-zig"),
        lang("nim", &[".nim", ".nims"], &[], &[], "text/x-nim"),
        lang("ocaml", &[".ml", ".mli"], &[], &[], "text/x-ocaml"),
        lang("wasm", &[".wat", ".wast"], &[], &[], "text/x-wasm"),
        lang("plaintext", &[".txt", ".text", ".log"], &[], &[], "text/plain"),
    ]
}
