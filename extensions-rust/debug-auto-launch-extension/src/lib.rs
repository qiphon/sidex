...
/// Debug Auto Launch extension.
/// Automatically launches debug sessions when SideX starts up.
pub struct DebugAutoLaunchExtension;

impl SidexExtension for DebugAutoLaunchExtension {
    ...
    fn provide_semantic_tokens_range(
        _: DocumentContext,
        _: Range,
    ...
    fn provide_semantic_tokens_delta(
        _: DocumentContext,
        _: String,
    ) -> Option<SemanticTokens> {
        None
    ...
    fn provide_call_hierarchy_incoming(
        _: DocumentContext,
        _: Position,
    ) -> Vec<DocumentSymbol> {
        vec![]
    ...
    fn provide_call_hierarchy_outgoing(
        _: DocumentContext,
        _: Position,
    ) -> Vec<DocumentSymbol> {
        vec![]
    ...
    fn provide_type_hierarchy_subtypes(
        _: DocumentContext,
        _: Position,
    ) -> Vec<DocumentSymbol> {
        vec![]
    ...
    fn provide_type_hierarchy_supertypes(
        _: DocumentContext,
        _: Position,
    ) -> Vec<DocumentSymbol> {
        vec![]
    ...
    fn on_files_will_create(
        _: Vec<String>,
    ) -> Option<Vec<(String, Vec<TextEdit>)>> {
        None
    }

    fn on_files_will_rename(
        _: Vec<String>,
        _: Vec<String>,
    ) -> Option<Vec<(String, Vec<TextEdit>)>> {
        None
    ...
    fn execute_command(_: String, _: String) -> Result<String, String> {
        Err("no commands registered".into())
    }
}

sidex_extension_sdk::export_extension!(DebugAutoLaunchExtension);
