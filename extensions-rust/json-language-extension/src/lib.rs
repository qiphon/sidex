...
/// JSON language features for SideX.
pub struct JsonLanguageExtension;

impl SidexExtension for JsonLanguageExtension {
    ...
    fn get_name() -> String {
        "JSON Language Features".to_string()
    }
...
sidex_extension_sdk::export_extension!(JsonLanguageExtension);
