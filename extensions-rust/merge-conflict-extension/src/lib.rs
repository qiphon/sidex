...
/// Merge conflict detection and resolution for SideX.
pub struct MergeConflictExtension;

impl SidexExtension for MergeConflictExtension {
...
sidex_extension_sdk::export_extension!(MergeConflictExtension);
