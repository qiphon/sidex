...
/// Debug Server Ready extension.
/// Opens browser when debug server is ready.
pub struct DebugServerReadyExtension;

impl SidexExtension for DebugServerReadyExtension {
...
sidex_extension_sdk::export_extension!(DebugServerReadyExtension);
